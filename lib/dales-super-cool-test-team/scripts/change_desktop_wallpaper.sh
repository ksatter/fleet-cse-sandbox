...
new_wallpaper_url="https://drive.usercontent.google.com/download?id=1fKo8rKR3j1IpNcwvByNsmxZrA-QFG4Vk"

# Define the path where the new wallpaper will be saved
new_wallpaper_path="/tmp/custom_background.jpg"
...
echo "Wallpaper changed to $new_wallpaper_path"